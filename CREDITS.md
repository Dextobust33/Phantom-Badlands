...
Phantom Badlands uses third-party assets under their respective licenses.
This file is the authoritative attribution record. The in-game credits
screen (Settings → Credits) reflects this list.

---

## Game

- **Phantom Badlands** by Dextobust33
- Built with the [Godot Engine](https://godotengine.org) (MIT License)
- SQLite addon: [godot-sqlite](https://github.com/2shady4u/godot-sqlite) (MIT License)

---

## Character Sprites (LPC — Liberated Pixel Cup)

Player character sprites are composed from the **Liberated Pixel Cup**
asset library via the LPC Universal Sprite Sheet Character Generator.
The pack draws on many community contributors; primary attribution
goes to wulax (LPC Medieval Fantasy Character Sprites) and the
generator project itself.

- **"LPC Medieval Fantasy Character Sprites"** by **wulax**
  - Source: <https://opengameart.org/content/lpc-medieval-fantasy-character-sprites>
  - License chosen for this project: **OGA-BY 3.0** (<https://static.opengameart.org/OGA-BY-3.0.txt>) — author triple-licenses under CC-BY-SA 3.0 / GPL 3.0 / OGA-BY 3.0; we select OGA-BY 3.0 to avoid share-alike obligations.
  - Modifications: assembled, layered, and recolored via the LPC Character Generator.

- **LPC Universal Sprite Sheet Character Generator**
  - Web tool: <https://liberatedpixelcup.github.io/Universal-LPC-Spritesheet-Character-Generator/>
  - Repository: <https://github.com/LiberatedPixelCup/Universal-LPC-Spritesheet-Character-Generator>

Per-part attribution for every part used in every class is preserved
verbatim in `client/sprites/classes/<class>.credits.txt`. Those files
ship with the release (do not delete them — they are the OGA-BY 3.0
paper trail). The full per-part credits are inlined below for
convenience.

### Per-class part attribution
...
shield/spartan/bg/walk/spartan.png
	- Licenses:
		- OGA-BY 3.0
	- Authors:
		- bluecarrot16
...
hair/xlong/adult/fg/walk.png
	- Note: Original by Nila122; cleaned up, resplit into separate layers, and added jump/run/sit/revised combat by JaidynReiman
	- Licenses:
		- OGA-BY 3.0
		- CC-BY-SA 3.0
		- GPL 2.0
...
torso/waist/sash/male/walk/black.png
	- Licenses:
		- OGA-BY 3.0
		- GPL 2.0
		- GPL 3.0
...
hat/helmet/spangenhelm_viking/adult/walk.png
	- Licenses:
		- CC-BY 3.0
		- CC-BY 4.0
		- OGA-BY 3.0
...
hat/cloth/hood/adult/walk/blue.png
	- Note: Brown hood by Wulax, original black/white recolors by ??, mapped to idle/run/jump/revised combat by JaidynReiman, along with additional recolors.
	- Licenses:
		- OGA-BY 3.0
		- CC-BY-SA 3.0
		- GPL 3.0
...
torso/waist/belt_robe/male/walk/teal.png
	- Licenses:
		- OGA-BY 3.0
		- CC-BY-SA 3.0
		- GPL 3.0
...
legs/skirts/plain/male/walk.png
	- Note: original by wulax, edited for female base by pvigier, edited for v3 base by bluecarrot16, idle & sit by Ahmad3366, color reduced & female sit/emote by JaidynReiman
	- Licenses:
		- OGA-BY 3.0
		- CC-BY-SA 3.0
		- GPL 3.0
...
weapon/magic/wand/male/walk/wand.png
	- Licenses:
		- CC-BY-SA 3.0
		- GPL 3.0
		- OGA-BY 3.0
...
weapon/magic/crystal/universal/foreground/walk/blue.png
	- Licenses:
		- OGA-BY 3.0+
		- GPL 3.0
		- CC-BY 4.0
...
hat/cloth/hood/adult/walk/hood_brown.png
	- Note: Brown hood by Wulax, original black/white recolors by ??, mapped to idle/run/jump/revised combat by JaidynReiman, along with additional recolors.
	- Licenses:
		- OGA-BY 3.0
		- CC-BY-SA 3.0
...
torso/jacket/tabard/male/walk/leather.png
	- Note: original by wulax, edited to v3 base by bluecarrot16
	- Licenses:
		- OGA-BY 3.0
		- CC-BY-SA 3.0
		- GPL 3.0
...
torso/armour/leather/male/walk.png
	- Note: adapted to v3 bases by bluecarrot16, reduced colors and climb/emote/jump by JaidynReiman
	- Licenses:
		- OGA-BY 3.0
		- CC-BY-SA 3.0
		- GPL 3.0
...
weapon/ranged/bow/normal/universal/background/walk/dark.png
	- Note: original by wulax, walk animations by pvigier, split into layers and tweaked for v3 character bases by bluecarrot16. pvigier has agreed to license this sheet as OGA-BY 3.0+.
	- Licenses:
		- OGA-BY 3.0+
		- GPL 3.0
		- CC-BY 4.0
...
weapon/ranged/bow/arrow/walk/arrow.png
	- Licenses:
		- OGA-BY 3.0
		- CC-BY-SA 3.0
		- GPL 3.0
...
weapon/sword/katana/walk/walk/katana.png
	- Licenses:
		- OGA-BY 3.0
	- Authors:
...
hat/cloth/hood/adult/walk/hood_black.png
	- Note: Brown hood by Wulax, original black/white recolors by ??, mapped to idle/run/jump/revised combat by JaidynReiman, along with additional recolors.
	- Licenses:
		- OGA-BY 3.0
		- CC-BY-SA 3.0
...
*(Existing audio assets predate this credits file. If any of the
`audio/*.wav` files were sourced externally, attribution should be added
here. If they are bespoke or the user holds rights, no entry is needed.)*

---

## License Notice

Where assets are licensed under OGA-BY 3.0, the full license text is
reproduced at:
- <https://static.opengameart.org/OGA-BY-3.0.txt>

OGA-BY 3.0 in summary: free for any use including commercial, requires
attribution to the original author(s) and a link to the license.

A small number of LPC parts used in this project are released under
