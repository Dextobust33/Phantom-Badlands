...
const TRICKSTER_ABILITIES = {
	...
	"vanish": {"level": 60, "cost": 40, "name": "Phantom Strike", "desc": "Strike from the dark; your next damaging action crits"},
	"exploit": {"level": 80, "cost": 35, "name": "Exploit", "desc": "Deal 10-22% of monster's max HP"},
	"perfect_heist": {"level": 100, "cost": 50, "name": "Assassinate", "desc": "Instant win + double rewards"}
}
