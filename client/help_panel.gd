...
const HELP_TOPICS := {
	"companion_stable": {
		...
		"body": (
			...
			+ "  • [color=#FFD700]Same Type[/color] — 3 of same monster type AND rank → next rank (rank 9 is the cap).\n"
			+ "  • [color=#FF00FF]Mixed A9[/color] — 8 [b]A8[/b] companions (tier A, rank 8) → random A9 companion. The capstone fusion.\n"
			+ "  • [color=#FF66FF]Hybrid[/color] — 2 different monster types both rank 5+, consumes 1 [color=#FFD700]Hybrid Catalyst[/color] → hybrid blend.\n"
			+ "  • [color=#FFAA66]Tier Ascend[/color] — 3 of same monster type AND same tier (any rank), consumes 1 [color=#FFD700]Ascension Catalyst[/color] → same type at tier+1, rank 1. Keeps your pet's identity while raising rank.\n"
	...
	"home_stone_companion": {
		...
		"body": (
			...
			+ "  • [b]Survives permadeath.[/b] On character death, the companion's current state (XP, level, rank) is saved.\n"
	...
	"companions_page": {
		...
		"body": (
			...
			+ "  • [b]<letter><number>[/b] — tier and rank, e.g. [b]D5[/b]. Tiers run [b]H G F E D C B A S[/b], weakest to strongest; rank runs 1-9 within a tier. Both climb the same way, so D9 beats D1 and C1 beats D9. Hover any label for the full ladder.\n"
	...
	"inventory_page": {
		...
		"body": (
			...
			+ "[color=#FFD700]── Equipping & using items ──[/color]\n"
			+ "  • [b]Double-click[/b] an item to equip it (equipment/tools) or use it (consumables).\n"
			+ "  • [b]Drag[/b] an item onto its slot on the Equipped doll to equip it.\n"
			+ "  • [b]Drag an equipped slot[/b] off the doll (anywhere on the panel) to unequip it.\n"
			+ "  • [b]Right-click[/b] anything for the full menu: Inspect / Use / Equip / Unequip / Lock / Salvage / Drop.\n"
			+ "  • [b]Hover[/b] for a detailed tooltip (stats, comparison to current gear, source for materials).\n\n"
			+ "[color=#FFD700]── Salvaging ──[/color]\n"
			+ "  • [b]Right-click → Salvage[/b] breaks down a single item into crafting materials (with a confirm).\n"
			+ "  • The [b]Salvage ▾[/b] button has the bulk verbs: Junk (below your level), ALL equipment, consumables, plus Full Options for auto-salvage rarity + affix filters.\n"
			+ "  • [b]Locked[/b] items are always skipped — lock anything you want to keep safe.\n\n"
			+ "[color=#FFD700]── Materials ──[/color]\n"
			+ "  • Gathered resources live in their own group — use them as crafting inputs. The [b]Materials[/b] button shows your full pouch.\n\n"
	...
	"fusion_overview": {
		...
		"body": (
			...
			+ "[color=#A335EE]✦ Same Type[/color] — 3 companions of the same monster type and the same rank → 1 companion of the next rank. Path to maxing within a tier.\n\n"
			+ "[color=#A335EE]✦ Mixed A9[/color] — 8 [b]A8[/b] companions (tier A, rank 8). Types can differ. → 1 random A9 companion. The capstone fusion.\n\n"
	...
	"fusion_panel": {
		...
		"body": (
			...
			+ "Pick 3 companions of the same monster type AND the same rank → 1 companion of the next rank. Caps at rank 9. The bread-and-butter path to maxing a rank ladder.\n\n"
			+ "[color=#FFD700]── Mixed A9 ──[/color]\n"
			+ "Select exactly 8 [b]A8[/b] companions (tier A, rank 8; types can differ) → 1 random [b]A9[/b]. The capstone fusion — only available once you've ground all the way to A8 across enough species.\n\n"
			+ "[color=#FFD700]── Hybrid ──[/color]\n"
			+ "Select exactly 2 companions of [b]different[/b] monster types, both at rank 5+. Consumes 1 [color=#FFD700]Hybrid Catalyst[/color] (drops from tier D+ dungeon chests). Produces a hybrid that blends bonuses from both parents and inherits the second parent's threshold ability. Lets you fuse synergies across species.\n\n"
			+ "[color=#FFD700]── Tier Ascend ──[/color]\n"
			+ "Select 3 companions of the [b]same monster type AND same tier[/b] (any rank mix). Consumes 1 [color=#FFD700]Ascension Catalyst[/color] (drops from tier C+ dungeon chests). Produces 1 companion of the [b]same type one tier letter higher, rank 1[/b]. Lets you keep your favorite pet's identity while climbing the tier ladder. Output gets a [color=#FFAA66]Veteran/Champion/Warlord/Tyrant/Apex[/color] prefix marking how many tier-steps you've climbed.\n\n"
			+ "[color=#FF8888]Notes[/color]:\n"
