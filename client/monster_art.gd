...
# Per-monster font size overrides for larger/more detailed art
const FONT_SIZE_OVERRIDES = {
	"Goblin": 5,  # 150-char wide detailed art needs smaller font
}
...
"     .....","[/color]"],
		...
		# New Phantasia 5 inspired monsters
		"Siren": ["[color=#00BFFF]",
"      ~^~",
"     (o o)",
"    <  ♪  >",
...
static func get_bordered_art_with_font(monster_name: String) -> String:
	...
	# Check for per-monster font size override
	var font_size = FONT_SIZE_OVERRIDES.get(monster_name, ASCII_ART_FONT_SIZE)
	return "[font_size=%d]%s[/font_size]" % [font_size, bordered_art]
