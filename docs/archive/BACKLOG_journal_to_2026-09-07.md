# ARCHIVED — Backlog journal up to 2026-09-07

**This is history, not a to-do list.** It is the working journal that `docs/BACKLOG.md` became
between roughly 2026-08 and 2026-09-07: 6,160 lines and 129 sections, most of them findings that
have since been acted on, superseded, or retracted.

It is kept because the REASONING is valuable — several entries record why an approach was rejected,
and re-proposing those is the most common way to waste a session. Search it before re-opening
anything. Do not treat an unchecked box in here as an open task: many were closed by later work
that never came back to tick them.

The live ordered list is `docs/BACKLOG.md`.
